                      ...
                      tabItems(
                        tabItem(tabName = "dashboard",
                                ...
                                p("Here in this dashboard I will be evaluating student progress on math exams
                                       given a variety of attributes. To look at the code that went into this Shiny app
                                  and the dataset used, please refer to my GitHub repository: https://github.com/lstaugler/Shiny_Student_App.
                                  
                                  Going through the data science life cycle, the given data did not require any extensive cleaning which was a helpful
                                  start. Next I chose to do a regression problem since a lot of the data was numeric and the target attribute, G3, was numeric.
                                  I then built the regression formula as seen in the regression tab. This allows the user to build their ideal
                                  linear regression model to see how well we can fit the data."),  
                                br(),
